...
public class LoopJoinOperatorTest extends OperatorTest {
    ...
    public void testBasic() throws Exception {
        ...
        LoopJoinOperator loopJoinOperator = new LoopJoinOperator(new ListOperator(lSchema, tuplesL),
    ...
    public void testMultipleJoinRecords() throws Exception {
        ...
        LoopJoinOperator loopJoinOperator = new LoopJoinOperator(new ListOperator(multiLSchema, tuplesL),
